...
public class Claims {
	...
	private final ObjectProperty<LocalTime> accidentTime;
	...
	public Claims() {
		...
		this.accidentTime = new SimpleObjectProperty<LocalTime>(this,"AccidentTime",null);
	...
	public Claims(int claimID, int clientID, int advisorID, int policyID, String claimStatus,
			LocalDate dateFiled, LocalTime accidentTime, String damage, String description, String payInfo,
		...
		this.accidentTime = new SimpleObjectProperty<LocalTime>(this,"AccidentTime",accidentTime);
	...
	public ObjectProperty<LocalTime> accidentTimeProperty() {
		return accidentTime;
	}

	//Sets time of accident
	public void setAccidentTime(String accidentTime) {
		this.accidentTime.set(LocalTime.parse(accidentTime));
	}
