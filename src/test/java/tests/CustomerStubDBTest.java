...
public class CustomerStubDBTest {
    ...
    void setUp() {
        ...
        db.addCustomer(new Customer(1, "John", "test123", "John", "Doe", "john@example.com", "123 Main St", "555-1234", "Male", 30, vehicleObservableList));
        db.addCustomer(new Customer(2, "Jane","pass456", "Jane", "Doe", "jane@example.com", "456 Park Ave", "555-5678", "Female", 25, vehicleObservableList));
    }
    ...
    void testAddCustomer() {
        ...
        db.addCustomer(new Customer(3, "password789", "Jim", "Beam", "jim@example.com", "789 Elm St", "555-6789", "Male", null, 40,vehicleObservableList));
    ...
    void testUpdateCustomer() {
        ObservableList<Vehicle> vehicleObservableList = FXCollections.observableArrayList();
        Customer updatedCustomer = new Customer(1, "John", "newpass123", "John", "Doe", "johnny@example.com", "123 Main St", "555-1234", "Male", 31, vehicleObservableList);
        assertTrue(db.updateCustomer(1, updatedCustomer));
        assertEquals("johnny@example.com", db.getCustomer(1).getEmail().getValue());
    }
    ...
    void testFindCustomersByAddress() {
        ...
        assertEquals("John", customers.get(0).getFirstName().getValue());
    }

    @Test
    void testQueryCustomers() {
        List<Customer> maleCustomers = db.queryCustomers(customer -> "Male".equals(customer.getGender().getValue()));
        assertEquals(1, maleCustomers.size());
        assertEquals("John", maleCustomers.get(0).getFirstName().getValue());
    }
    ...
    void testFindCustomersByPhoneNumber() {
        ...
        assertEquals("John", result.get(0).getFirstName().getValue());
    }
    ...
    void testUpdateCustomerEmail() {
        ...
        assertEquals("newemail@example.com", customer.getEmail().getValue());
    }
    ...
    void testAddCustomers() {
        ...
        db.addCustomers(Arrays.asList(
            new Customer(3, "unique123", "Alice", "Wonder", "alice@example.com", "111 Alice Ln", "555-0001", "Female", null, 28, vehicleObservableList),
            new Customer(4, "unique456", "Bob", "Builder", "bob@example.com", "222 Bob St", "555-0002", "Male", null, 35, vehicleObservableList)
        ));
